package com.rovaind.academy.about;
...
public class AboutActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appname.setText(getResources().getString(R.string.about_application));
        // Back Button
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.licenses:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://sites.google.com/view/elmohader")));
                break;
