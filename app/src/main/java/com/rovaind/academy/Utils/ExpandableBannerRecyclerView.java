...
public class ExpandableBannerRecyclerView extends RecyclerView {
    public ExpandableBannerRecyclerView(Context context)
    {
        super(context, null);
        initRecycler();
    }

    public ExpandableBannerRecyclerView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initRecycler();
    }

    public ExpandableBannerRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    static class SavedState implements Parcelable
    {
        ...
        {
            Parcelable superState = in.readParcelable(ExpandableBannerRecyclerView.class.getClassLoader());
    ...
    public static abstract class Adapter<CVH extends ViewHolder, GVH extends ViewHolder, C, G> extends RecyclerView.Adapter<ViewHolder>
    {
        ...
        public abstract int getChildItemViewType(int group, int position , int type);
        ...
        public int getItemViewType(int i)
        {
            ...
            while (group <= getGroupItemCount()) {
                ...
                if (i > 0 && isExpanded(group)) {
                    ...
                    if (i < getChildItemCount(group))
                        return getChildItemViewType(group, i , 0);
                    i -= getChildItemCount(group);
                    group++;
                    continue;
                }
    ...
    public static class SimpleGroupViewHolder extends GroupViewHolder
    {
        ...
        {
            super(View.inflate(context, R.layout.exr_banner_group, null));
        ...
        public void setText(String t , Context context) {
            Glide.with(context).load(RetrofitClient.BASE_CategoryImage_URL + t).into(imageView);
