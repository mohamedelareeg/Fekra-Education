package com.rovaind.academy.Utils.views;
...
public class TextViewAr extends TextView {
    ...
    public void init() {
        Typeface tf = Typeface.createFromAsset(getContext().getAssets(), "font/Hacen-Sahara-St.ttf");//Hacen-Sahara-St.ttf qatar.ttf
