package com.rovaind.academy.Utils.searchbar;
...
import com.rovaind.academy.Utils.searchbar.adapter.DefaultSuggestionsAdapter;
import com.rovaind.academy.Utils.searchbar.adapter.SuggestionsAdapter;
...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    private TextViewAr placeHolder;
    ...
    private void init(AttributeSet attrs) {
        ...
        arrowIconRes = array.getResourceId(R.styleable.MaterialSearchBar_mt_backIconDrawable, R.drawable.ic_arrow_left_48dp);
    ...
    private void setupCursorColor() {
        try {
            Field field = TextViewAr.class.getDeclaredField("mEditor");
            field.setAccessible(true);
            Object editor = field.get(searchEdit);

            field = TextViewAr.class.getDeclaredField("mCursorDrawableRes");
            field.setAccessible(true);
    ...
    private void animateNavIcon() {
        ...
        {
            Log.d(TAG, "animateNavIcon: " + e.getLocalizedMessage());
        }
    ...
    public TextViewAr getPlaceHolderView() {
        return placeHolder;
    }
