...
import com.rovaind.academy.Utils.LocaleHelper;
import com.rovaind.academy.Utils.ThemeUtil;
...
import com.rovaind.academy.adapter.ThemeAdapter;
...
public class SettingsActivity extends BaseActivity implements View.OnClickListener{
   ...
   // private SectionsPagerAdapter    mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appname.setText(getResources().getString(R.string.action_settings));
        // Back Button
    ...
    {
        Intent loginIntent = new Intent(SettingsActivity.this, FacebookLoginActivity.class);
