...
import com.rovaind.academy.adapter.SliderAdapter;
...
//        if (current < layouts.length) {
    ...
    private void launchHomeScreen() {
        SharedPrefManager.getInstance(getApplicationContext()).GuestVisit();
        finish();
        if(SharedPrefManager.getInstance(getApplicationContext()).getSelectedClass() == 0) {
