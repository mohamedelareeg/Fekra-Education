 ...
 */
public class CommentsPostsHomeRecyclerAdapter extends RecyclerView.Adapter<CommentsPostsHomeRecyclerAdapter.ViewHolder> {
    ...
    public CommentsPostsHomeRecyclerAdapter(List<CommentPost> commentsList , Post postList  ){
    ...
    @Override
    public CommentsPostsHomeRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.comment_list_item, parent, false);
        context = parent.getContext();

        return new CommentsPostsHomeRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CommentsPostsHomeRecyclerAdapter.ViewHolder holder, int position) {
...
//        holder.ratingBar.setRating(commentsList.get(position).getRate());
        ...
        holder.image_like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                holder.CreateLike(commentsList.get(position)   , time , position);
                /*
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void CreateLike(CommentPost comment  , long time , int position) {
