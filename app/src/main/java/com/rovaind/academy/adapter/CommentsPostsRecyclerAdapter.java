 ...
 */
public class CommentsPostsRecyclerAdapter extends RecyclerView.Adapter<CommentsPostsRecyclerAdapter.ViewHolder> {
    public List<CommentPost> commentsList;
    ...
    public CommentsPostsRecyclerAdapter(List<CommentPost> commentsList , Post postList , Course SelectedCourse ){
    ...
    @Override
    public CommentsPostsRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.comment_list_item, parent, false);
        context = parent.getContext();

        return new CommentsPostsRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CommentsPostsRecyclerAdapter.ViewHolder holder, int position) {
        ...
        CommentPost c = commentsList.get(position);
...
//        holder.ratingBar.setRating(commentsList.get(position).getRate());
        ...
        holder.image_like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                holder.CreateLike(commentsList.get(position) , SelectedCourse  , time , position);
                /*
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void fillComment(String userName, CommentPost comment, ExpandableTextView commentTextView, TextView dateTextView) {
        ...
        private void CreateLike(CommentPost comment , Course course , long time , int position) {
                ...
                public void onResponse(Call<LikePostResponse> call, Response<LikePostResponse> response) {
                    ...
                    if (response.body() != null) {
                        ...
                        if(response.message().equals("Like Added"))
                        {
                            ...
                            //image_like.setImageDrawable(ContextCompat.getDrawable(context , R.drawable.ic_active_like));
                            comment_like_count.setText(comment.getLikeCount() + " " + context.getResources().getString(R.string.likes));

                        }
                        else if(response.message().equals("Like Already Added"))
                        {
                            image_like.setPressed(false);
                            //comment_like_count.setImageDrawable(ContextCompat.getDrawable(context ,R.drawable.ic_like));
