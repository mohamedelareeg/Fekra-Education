...
- **MsvSearch:** Search library for Android.  
  [GitHub Repository](https://github.com/claudiodegio/MsvSearch)  
  Version: 1.0.0  
...
- **Volley:** HTTP library for Android.  
  [GitHub Repository](https://github.com/google/volley)  
  Version: 1.1.1  
  Author: Google, Inc.  
  License: Apache License 2.0
...
- **CardView:** AndroidX library for rendering cards.  
  [Documentation](https://developer.android.com/jetpack/androidx/releases/cardview)  
  Version: 1.0.0  
  Author: Google, Inc.  
  License: Apache License 2.0

- **Core-KTX:** AndroidX library for Kotlin extensions.  
  [GitHub Repository](https://github.com/android/android-ktx)  
  Version: 1.6.0  
  Author: Google, Inc.  
  License: Apache License 2.0
